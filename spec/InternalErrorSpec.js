...
var InternalError = require("../lib/InternalError.js");
...
describe("InternalError", function() {
    ...
    it("does not have a stack trace, when an error is supplied", function() {
        var ce = new InternalError(message, error);
    ...
    it("is of type InternalError", function() {
        var ce = new InternalError();
        expect(ce instanceof InternalError).toBeTruthy();
    });
});
